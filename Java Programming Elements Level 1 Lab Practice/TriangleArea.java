...
public class TriangleArea {
    public static void main(String[] args) {
        ...
        // Step 1: Take user input for base and height in inches
        ...
        if (baseInches <= 0 || heightInches <= 0) {
            System.out.println("Base and height must be positive numbers.");
        } else {
            // Step 2: Calculate area in square inches
            double areaInches = 0.5 * baseInches * heightInches;

            // Step 3: Convert area to square centimeters (1 inch = 2.54 cm)
